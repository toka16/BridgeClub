...
public class ConnectionPool implements Runnable {
	...
	public ConnectionPool(String addressDB, String user, String password){
		try {
			Class.forName(DRIVER_CLASS_URL);
	...
	private static final String DRIVER_CLASS_URL = "com.mysql.jdbc.Driver";
}
